  ...
  return (
    ...
    <header className="bg-indigo-700 w-full px-4 py-3 flex justify-center">
     ...
     <main>
      <div>
        <h1>How It Works</h1>
        <p>Tailwind is designed for rapid development of modern applications. At its core, it is a robust mobile-first design system built with developer experience in mind. After using Tailwind CSS, you will find it difficult to go back to use anything else. Learn all about it in this all-inclusive course.</p>
      </div>
      <div>
        <h1>Advantages</h1>
        <div>
          <img/>
          <h2>No Custom CSS</h2>
          <p>Tailwind's advanced class extraction will leave your project free of custom CSS.</p>
        </div>
        <div>
          <svg></svg>
          <h2>Developer Experience</h2>
          <p>Tailwind is designed with your happiness in mind. The ease of performing changes is refreshin.
          </p>
        </div>
        <div>
          <img/>
          <h2>Mobile Friendly</h2>
          <p>Modern applications demand mobile-friendly & Tailwind's responsive modifiers make it easy.</p>
        </div>
      </div>
      <div>
        <h1>Sign up to download the free PDF</h1>
        <input></input>
        <input></input>
        <input></input>
        <input></input>
